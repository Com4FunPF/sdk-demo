...
public final class Json {
    ...
    private final static Gson NO_ANNOTATION_GSON =
            new GsonBuilder().enableComplexMapKeySerialization().create();

    public static String toJsonWithNoAnnotation(Object object) {
        return NO_ANNOTATION_GSON.toJson(object);
    }

    public static <T> T fromWithNoAnnotation(String json, Class<T> cls) {
        return NO_ANNOTATION_GSON.fromJson(json, cls);
    }
